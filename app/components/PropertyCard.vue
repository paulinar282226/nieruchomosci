...
<template>
  <div class="card property-card">
    <div class="card-image">
      ...
      <button class="favorite-btn" :class="{ 'is-favorite': isFav }" @click="toggleFavorite">
        {{ isFav ? '❤️' : '🤍' }}
      </button>
    </div>
    <div class="card-content">
      ...
      <div class="property-price">
        ...
        <p class="is-size-7 has-text-grey">{{ formatPrice(listing.pricePerMeter) }}/m²</p>
      </div>
      ...
      <NuxtLink :to="`/oferta/${listing.id}`" class="button is-fullwidth is-info mt-3">
        Szczegóły
      </NuxtLink>
    </div>
  </div>
