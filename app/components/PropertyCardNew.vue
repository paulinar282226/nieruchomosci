...
<template>
  <div class="card-modern">
    <div
      class="card-modern__image"
      @mouseenter="showQuickInfo = true"
      @mouseleave="showQuickInfo = false"
    >
      <img :src="listing.image" :alt="listing.title" />

      <div v-if="listing.isNew" class="card-modern__badge">NOWE</div>
      ...
      <div v-if="showQuickInfo" class="card-modern__overlay">
        <div class="overlay-content">
          ...
          <NuxtLink :to="`/oferta/${listing.id}`" class="overlay-link"> SZCZEGÓŁY → </NuxtLink>
        </div>
      </div>
    </div>
    ...
    <div class="card-modern__body">
      ...
      <div class="card-modern__footer">
        ...
        <NuxtLink :to="`/oferta/${listing.id}`" class="card-modern__cta"> ZOBACZ </NuxtLink>
      </div>
    </div>
  </div>
</template>
